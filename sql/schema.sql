...
VALUES
	...
	(6,'my github','https://github.com/1943lee','link',NULL,0,0);
...
VALUES
	...
	('site_keywords','tale Blog',NULL),
	('site_description','tale Blog',NULL),
	('site_record','','备案号'),
	('site_url', '', NULL);
...
VALUES
	(1, 'admin', 'a66abb5684c45962d887564f08346e8d', NULL, NULL, 'admin', 1490756162, 0, 0, 'visitor');