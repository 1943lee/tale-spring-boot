...
import com.lcy.tale.utils.IPKit;
import com.lcy.tale.utils.PatternKit;
...
public class IndexController extends BaseController {
    ...
    public String index(HttpServletRequest request, @PathVariable int p, @RequestParam(value = "limit", defaultValue = "12") int limit) {
        ...
        PageInfo<ContentsVo> articles = contentService.getContents(p, limit);
     ...
     * @param contents
     */
    private void completeArticle(HttpServletRequest request, ContentsVo contents) {
    ...
    public String categories(HttpServletRequest request, @PathVariable String keyword,
        ...
        PageInfo<ContentsVo> contentsPaginator = contentService.getArticles(metaDto.getMid(), page, limit);
    ...
    public String links(HttpServletRequest request) {
        List<MetasVo> links = metaService.getMetas(Types.LINK.getType());
    ...
    public String page(@PathVariable String pagename, HttpServletRequest request) {
        ContentsVo contents = contentService.getContents(pagename);
        if (null == contents) {
            return this.render_404();
        }
        if (contents.getAllowComment()) {
    ...
    public String search(HttpServletRequest request, @PathVariable String keyword, @PathVariable int page, @RequestParam(value = "limit", defaultValue = "12") int limit) {
        page = page < 0 || page > WebConst.MAX_PAGE ? 1 : page;
        PageInfo<ContentsVo> articles = contentService.getArticles(keyword, page, limit);
        request.setAttribute("articles", articles);
